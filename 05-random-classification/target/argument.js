...
const yargsParser = Yargs(rawCommandArguments)
    .command('classifyRandomly <inputFile> <outputFile', 'classify words into random parts of speech', (yargs) => {
    yargs.positional('inputFile', {
        describe: 'a file containing words and parts of speech data',
        type: 'string',
        normalize: true
    }).positional('outputFile', {
        describe: 'a file to write report data to',
        type: 'string',
        normalize: true
    });
});
